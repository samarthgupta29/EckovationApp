 ...
 * {@link UnansweredQuestionsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link UnansweredQuestionsFragment#newInstance} factory method to
...
public class UnansweredQuestionsFragment extends Fragment {
    ...
    public UnansweredQuestionsFragment() {
     ...
     * @return A new instance of fragment UnansweredQuestionsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UnansweredQuestionsFragment newInstance(String param1, String param2) {
        UnansweredQuestionsFragment fragment = new UnansweredQuestionsFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        allFeedRecyclerView = getView().findViewById(R.id.unans_rv);
        ...
        allFeedAdapter = new AllFeedAdapter(allFeedRepository.fetchUnansList());
